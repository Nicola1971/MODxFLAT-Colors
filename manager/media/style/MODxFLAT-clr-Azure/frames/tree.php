...
if(IN_MANAGER_MODE!="true") die("<b>INCLUDE_ORDERING_ERROR</b><br /><br />Please use the MODX Content Manager instead of accessing this file directly.");
    ...
    function constructLink($action, $img, $text, $allowed) {
        ...
        <?php } ?>
               <i class="<?php echo $img; ?> primarycolor"></i> <?php echo $text; ?>
            </div>
        <?php
    }
  ...
  <tr>
    <td>
        <table cellpadding="0" cellspacing="0" border="0">
			...
			<td><a href="#" class="treeButton" title="<?php echo $_lang['images_management'];?>" onclick="window.open('media/browser/mcpuk/browse.php?&type=images','gener','width=800,height=600,top='+((screen.height-600)/2)+',left='+((screen.width-800)/2)+',toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no')"><?php echo $_style['images_management'] ; ?></a></td>
            
            <td><a href="#" class="treeButton" title="<?php echo $_lang['files_management'];?>" onclick="window.open('media/browser/mcpuk/browse.php?&type=files','gener','width=800,height=600,top='+((screen.height-600)/2)+',left='+((screen.width-800)/2)+',toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no')"><?php echo $_style['files_management'] ; ?></a></td>
            
         <!---   <td><a href="#" class="treeButton" title="<?php echo $_lang['element_management'];?>" onclick="window.open('index.php?a=76','gener','width=800,height=600,top='+((screen.height-600)/2)+',left='+((screen.width-800)/2)+',toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no')"><?php echo $_style['element_management']; ?></a></td>--->
...
<div id="mx_contextmenu" onselectstart="return false;">
    ...
    constructLink(2, $_style["ctx_save"], $_lang["edit_resource"], $modx->hasPermission('edit_document')); // edit
